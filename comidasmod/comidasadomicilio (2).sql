...
--
-- Host: 127.0.0.1
-- Generation Time: May 09, 2014 at 02:32 AM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_clasearticulo`( articulo1 VARCHAR(10),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_cliente`(IN `id` DECIMAL(5,0), IN `nombre` VARCHAR(20), IN `apellido` VARCHAR(40), IN `direccion` VARCHAR(30), IN `telefono` DECIMAL(9,0), IN `pizza` DECIMAL(3,0), IN `bocadillo` DECIMAL(3,0), IN `complemento` DECIMAL(3,0))
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_cliente_obesquio`(IN `regalo` DECIMAL(4,0), IN `motivo` CHAR(1), IN `cliente` DECIMAL(5,0), IN `fecha` DATE)
    NO SQL
update obsequioc set motivo = motivo, cliente=cliente, fecha=fecha
where regalo=regalo$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_ingrediente`(ingrediente1 VARCHAR(4),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_pedido`(IN `clase` VARCHAR(20), IN `incremento` DECIMAL(5,0), IN `min` DECIMAL(4,0))
    NO SQL
update tipospedidos set clase_pedidos=clase, incremento=incremento, minimo=min where clase_pedidos=clase$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_pedido1`(IN `fecha` DATE, IN `pedido` DECIMAL(3,0), IN `clase` VARCHAR(20), IN `total` DECIMAL(4,0), IN `cliente` DECIMAL(5,0), IN `dni` VARCHAR(9), IN `valor` DECIMAL(4,0), IN `incremento` DECIMAL(3,0))
    NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_pizzasbase`( articulo1 VARCHAR(10),
                                             articulo2 VARCHAR(10),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_productoestrella`( nombre1 VARCHAR(15),
                                             nombre2 VARCHAR(15),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_recetaspizza`( articulo1 VARCHAR(10),
                                             articulo2 VARCHAR(10),
                                             ingrediente1 VARCHAR(4),
                                             ingrediente2 VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_actualiza_regalo`(IN `regalo1` DECIMAL(4,0), IN `motivo` CHAR(2), IN `limite` DECIMAL(2,0))
    NO SQL
update regalos set motivo=motivo, limite=limite
where regalo=regalo1$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta001`()
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta002`()
BEGIN
SELECT articulo, tamano, SUM(valor_venta) as ”INGRESOS” 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta004`()
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta005`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_consulta006`()
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_abastecer`(sco VARCHAR(6),fch VARCHAR(10))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_articulos`(art VARCHAR(10),tam VARCHAR(1))
begin
	SET foreign_key_checks=0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_clasearticulo`( _articulo VARCHAR(10) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_cliente`(IN `clienteid` DECIMAL(5,0))
delete from cliente where cliente = clienteid$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_cliente_obsequio`(IN `regalo1` DECIMAL(4,0))
    NO SQL
delete from obsequiosc where regalo=regalo1$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_ingrediente`(_ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_pedido`(IN `clase` VARCHAR(20))
    NO SQL
delete from tipospedidos where clase_pedidos=clase$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_pedido1`(IN `fecha1` DATE)
    NO SQL
delete from pedidos where fecha=fecha1$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_pizza`(art VARCHAR(10),tam VARCHAR(1))
begin
	SET foreign_key_checks=0;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_pizzasbase`( _articulo VARCHAR(10),_ingrediente VARCHAR(4) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_productoestrella`( nombre VARCHAR(15) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_recetaestrella`(_nombre_comercial VARCHAR(14))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_recetaspedidos`( _fecha DATE,_pedido DECIMAL(3,0),_venta DECIMAL(3,0), _ingrediente VARCHAR(4) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_recetaspizza`( _articulo VARCHAR(10),_ingrediente VARCHAR(4) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_regalo`(IN `regalo1` DECIMAL(4,0))
    NO SQL
delete from regalos where regalo=regalo1$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_scooter`(sco VARCHAR(6))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_elimina_ventasproductos`(fch VARCHAR(10),ped DECIMAL(3,0),vnt DECIMAL(3,0))
begin
	DELETE
		FROM ventasproductos 
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_abastecer`(sco VARCHAR(6),fch VARCHAR(10))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_articulos`(art VARCHAR(10),tam VARCHAR(1))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_clasearticulo`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_clasearticulo_esp`( _articulo VARCHAR(10) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_clientes_obsequio`()
    NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_ingredientes`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_ingrediente_esp`(_ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_pedido1`()
    NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_pizzas`(art VARCHAR(10),tam VARCHAR(1))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_pizzasbase`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_pizzasbase_esp`( _articulo VARCHAR(10), _ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_productoestrella`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_productoestrella_esp`( nombre VARCHAR(15) )
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_recetaestrella`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_recetaspizza`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_recetaspizza_esp`( _articulo VARCHAR(10), _ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_recetasventas`()
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_recetasventas_esp`( _fecha DATE,_pedido DECIMAL(3,0),_venta DECIMAL(3,0), _ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_regalo`()
    NO SQL
SELECT re.regalo as "REGALO", re.motivo as "MOTIVO", re.limite as "LIMITE" FROM regalos as re ORDER BY re.regalo ASC$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_scooters`(sco VARCHAR(6))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_tipopedido`()
    NO SQL
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_get_ventasproductos`()
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nueva_pizza`(art VARCHAR(10),tam VARCHAR(1),prc DECIMAL(3,0))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nueva_recetaestrella`( nombre_comercial VARCHAR(14),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nueva_ventasproductos`(fch VARCHAR(10),ped DECIMAL(3,0),vnt DECIMAL(3,0),
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_abastecer`(sco VARCHAR(6),fch DATE,cst decimal(3,0))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_articulo`(art VARCHAR(10),tam VARCHAR(1),prc DECIMAL(4,0))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_clasearticulo`(articulo VARCHAR(10), tipoarticulo VARCHAR(1))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_cliente`(IN `id` DECIMAL(5,0), IN `nombre` VARCHAR(20), IN `apellido` VARCHAR(40), IN `direccion` VARCHAR(30), IN `telefono` DECIMAL(9,0), IN `pizza` DECIMAL(3,0), IN `bocadillo` DECIMAL(3,0), IN `complemento` DECIMAL(3,0))
    NO SQL
insert into cliente values (id,nombre,apellido,direccion,telefono,pizza,bocadillo, complemento)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_cliente_obsequio`(IN `regalo` DECIMAL(4,0), IN `motivo` CHAR(1), IN `cliente` DECIMAL(5,0), IN `fecha` DATE)
    NO SQL
insert into obsequiosc values (regalo,motivo,cliente,fecha)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_ingrediente`(ingrediente VARCHAR(4),nombre VARCHAR(10))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_pedido1`(IN `fecha` DATE, IN `pedido` DECIMAL(3,0), IN `clase` VARCHAR(20), IN `total` DECIMAL(4,0), IN `cliente` DECIMAL(5,0), IN `dni` VARCHAR(9), IN `valor` DECIMAL(4,0), IN `incremento` DECIMAL(3,0))
    NO SQL
insert into pedidos values (fecha,pedido,clase,total,cliente,dni,valor,incremento)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_pizzasbase`(articulo VARCHAR(10), ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_productoestrella`( nombre VARCHAR(15),articulo VARCHAR (10) )
BEGIN 
INSERT INTO productosestrella VALUES ( nombre, articulo); 
END$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_recetaspizza`(articulo VARCHAR(10), ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_recetasventas`(fecha DATE,
                                          pedido DECIMAL(3,0),
                                          venta DECIMAL(3,0),
                                          ingrediente VARCHAR(4))
BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_regalo`(IN `regalo` DECIMAL(4,0), IN `motivo` CHAR(2), IN `limite` DECIMAL(2,0))
    NO SQL
insert into regalos
values(regalo, motivo,limite)$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_scooter`(sco VARCHAR(6),anio DECIMAL(4,0))
begin
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_nuevo_tipopedido`(IN `clase` VARCHAR(20), IN `incremen` DECIMAL(3,0), IN `min` DECIMAL(4,0))
    NO SQL
...
--
-- Table structure for table `clasearticulos`
--
...
--
-- Dumping data for table `clasearticulos`
--
...
--
-- Table structure for table `obsequiosc`
--
...
--
-- Dumping data for table `obsequiosc`
--
...
--
-- Table structure for table `obsequiosp`
--
...
--
-- Table structure for table `pizzasbase`
--
...
--
-- Dumping data for table `pizzasbase`
--
...
--
-- Table structure for table `productosestrella`
--
...
--
-- Dumping data for table `productosestrella`
--
...
--
-- Table structure for table `recetaestrella`
--
...
--
-- Dumping data for table `recetaestrella`
--
...
--
-- Table structure for table `recetasbocadillos`
--
...
--
-- Table structure for table `recetaspizzas`
--
...
--
-- Dumping data for table `recetaspizzas`
--
...
--
-- Table structure for table `recetasventa`
--
...
--
-- Table structure for table `tipospedidos`
--
...
--
-- Dumping data for table `tipospedidos`
--
...
--
-- Constraints for table `obsequiosc`
--
...
--
-- Constraints for table `obsequiosp`
--
...
--
-- Constraints for table `pizzasbase`
--
...
--
-- Constraints for table `productosestrella`
--
...
--
-- Constraints for table `recetaestrella`
--
...
--
-- Constraints for table `recetasbocadillos`
--
...
--
-- Constraints for table `recetaspizzas`
--
...
--
-- Constraints for table `recetasventa`
--
