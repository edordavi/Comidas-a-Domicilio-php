<?php
    ...
    require_once "cls_recetaspizza.php";

?>

<div class="full_width clear" id="datos2">
<fieldset><legend>Datos de las Recetas de las pizzas</legend>
...
<script type="text/javascript">
    function insertaRecetasPizza(){
        ...
        if(articulo !=""  && ingrediente != ""){
            ...
            var cadena = "cls_recetaspizza.php?accion=" + encodeURIComponent("insertar") +
