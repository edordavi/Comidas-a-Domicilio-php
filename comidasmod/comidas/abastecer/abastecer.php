...
<script type="text/javascript">
    function insertaFamilia(){
        ...
        var anio = document.getElementById("fch").value;
        ...
        if (!esValido){
            ...
            var cadena = "cls_abastecer.php?accion=" + encodeURIComponent("insertar") +
                    "&sco=" + encodeURIComponent(sco) + 
                    "&cst=" + encodeURIComponent(cst) +
                    "&fch=" + encodeURIComponent(anio);
            consulta(cadena);
    }
