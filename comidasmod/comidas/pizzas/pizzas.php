...
<script type="text/javascript">
    function insertaFamilia(){
        ...
        if (!esValido){
            ...
            var cadena = "cls_pizzas.php?accion=" + encodeURIComponent("insertar") +
